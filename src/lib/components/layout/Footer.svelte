...
<footer class="bg-gray-900 py-12 text-white">
	<div class="mx-auto max-w-7xl px-4">
		<div class="grid gap-8 md:grid-cols-4">
			...
			<div>
				<h4 class="mb-4 text-lg font-semibold">Menu Utama</h4>
				<ul class="space-y-2 text-sm">
					...
					<li>
						<a href="/uji-kompetensi" class="text-gray-400 hover:text-white">Uji Kompetensi</a>
					</li>
					<li><a href="/karir" class="text-gray-400 hover:text-white">Karir</a></li>
			...
			<div>
				<h4 class="mb-4 text-lg font-semibold">Kontak Info</h4>
				<div class="space-y-3 text-sm">
					<div class="flex items-start">
						<svg
							class="mt-1 mr-2 h-4 w-4 text-gray-400"
							fill="none"
							stroke="currentColor"
							viewBox="0 0 24 24"
						>
					...
					<div class="flex items-center">
						...
						<span class="text-gray-400">{$siteSettings.sitePhone || '+62821197042568'}</span>
					</div>
					<div class="flex items-center">
						<svg
							class="mr-2 h-4 w-4 text-gray-400"
						...
						<span class="text-gray-400"
							>{$siteSettings.siteEmail || 'lsp.manajerpendidikan@gmail.com'}</span
						>
					</div>
				</div>
			</div>
		...
		<div class="mt-8 border-t border-gray-800 pt-8 text-center">
			<p class="text-sm text-gray-400">
				{$siteSettings.siteCopyright ||
					`© ${new Date().getFullYear()} ${$siteSettings.siteName || 'LSP Manajemen Pendidikan Islam'}. All rights reserved.`}
			</p>
		</div>
	</div>
</footer>
